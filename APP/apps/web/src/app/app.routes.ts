...
import { InspectionDetailComponent } from './inspector/inspection-detail.component';
...
export const routes: Routes = [
  ...
  { path: 'app/inspections/:id', component: InspectionDetailComponent, canActivate: [signedIn] },
