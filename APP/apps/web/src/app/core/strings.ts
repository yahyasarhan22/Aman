...
export const T = {
  ...
  home: {
    ...
    inspectorEntry: 'تسجيل الدخول',
    trackComplaint: 'تتبّع حالة شكوى',
  },
  ...
  queue: {
    ...
    staleEntry: 'تغيّرت بيانات هذه المنشأة — جرى تحديث القائمة. حاول مرة أخرى.',
    remainingTab: 'المتبقية',
    completedToday: 'تم تفتيشها اليوم',
    completedEmpty: 'لم تُفتَّش أي منشأة بعد اليوم.',
  },
  ...
  checklist: {
    ...
    context: {
      title: 'سياق الزيارة — أين يجب أن تُركّز',
      hide: 'إخفاء',
      show: 'إظهار',
      violationsTitle: 'مخالفات مفتوحة من زيارة سابقة',
      complaintsTitle: 'شكاوى بانتظار التحقق',
      empty: 'لا توجد مخالفات مفتوحة أو شكاوى بانتظار التحقق لهذه المنشأة.',
      photoAttached: 'بصورة مرفقة من المشتكي',
    },
  },
  ...
  inspectionDetail: {
    ...
    submittedAt: 'تاريخ الزيارة',
    checklistTitle: 'قائمة التفتيش الكاملة',
    back: 'العودة إلى الجولة',
    loadFailed: 'تعذّر تحميل التفتيش.',
    violationStatus: {
      OPEN: 'مفتوحة',
      OWNER_RESPONDED: 'ردّ المالك',
      VERIFIED: 'تم التحقق',
      CLOSED: 'مغلقة',
      OVERDUE: 'متأخرة',
    } as Record<string, string>,
  ...
  admin: {
    ...
    complaints: {
      ...
      chooseInspectorFirst: 'اختر مفتشاً من القائمة قبل الإسناد.',
      chooseReasonFirst: 'اختر سبب الرفض من القائمة قبل الرفض.',
      assignedOk: 'تم الإسناد.',
      rejectedOk: 'تم رفض الشكوى.',
      closedOk: 'تم إغلاق الشكوى.',
      reason: {
