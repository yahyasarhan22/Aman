...
async function bootstrap() {
  ...
  // Explicit IPv4 bind — '::' (the Nest/Node default with no host) is
  // IPv6-only on a box without working dual-stack, silently unreachable to
  // any IPv4 client (e.g. a phone on the LAN) despite curl from this same
  // machine succeeding.
